...
| [Color Utilities](/api/color)        |       3 | Random color helpers for RGB, RGBA, and HEX color generation.                                              |
...
| [Function Utilities](/api/fn)        |       5 | Function flow helpers for composition, memoization, one-time invocation, and no-op usage.                  |
| [HTML Utilities](/api/html)          |       2 | Helpers for escaping and unescaping HTML-safe text.                                                        |
| [Type Guards and Checks](/api/is)    |      42 | A broad collection of runtime type guards and predicate helpers.                                           |
...
| [Number Utilities](/api/number)      |       4 | Helpers for random numbers, rounding, and number coercion.                                                 |
| [Object Utilities](/api/object)      |      12 | Utilities for deep merge/path operations, cloning, sorting, picking, omitting, and cleaning object values. |
