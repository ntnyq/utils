...
describe(normalizePathSlashes, () => {
  it('should replace backslashes with slashes', () => {
    expect(normalizePathSlashes(String.raw`a\b\c`)).toBe('a/b/c')
    expect(normalizePathSlashes(String.raw`path\to\file`)).toBe('path/to/file')
  })
  ...
  it('should handle mixed slashes', () => {
    expect(normalizePathSlashes(String.raw`a\b/c\d`)).toBe('a/b/c/d')
  })
