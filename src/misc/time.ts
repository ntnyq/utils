...
export const ONE_MINUTE_MILLSECONDS: number = 60 * 1000
export const ONE_HOUR_MILLSECONDS: number = 60 * 60 * 1000
export const ONE_DAY_MILLSECONDS: number = 24 * 60 * 60 * 1000
export const ONE_WEEK_MILLSECONDS: number = 7 * 24 * 60 * 60 * 1000
